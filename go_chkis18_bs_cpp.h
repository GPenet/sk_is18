...
void GCHK::Do_phase2(T4_TO_EXPAND w) {
	...
	Do_phase2Expand(w.bf,w.active);
}
void  GCHK::Do_phase2Expand(uint64_t bf, uint64_t ace) {
	int limspot = 17 - nphase1 - mincluesb3;
